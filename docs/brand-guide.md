...
Generated by `site/tools/generate_og_images.py`. Re-run after changing hero images.
...
#    Pillow is the canonical encoder — cwebp is NOT installed on the build machine
python3 -c "from PIL import Image; Image.open('/tmp/resized.png').save('output.webp','WEBP',quality=82,method=6)"
...
| Asset | File Path |
|-------|-----------|
| OG generator script | `site/tools/generate_og_images.py` |
