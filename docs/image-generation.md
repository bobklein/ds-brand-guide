...
```
sips --resampleWidth 1440 input.png --out /tmp/r.png && python3 -c "from PIL import Image; Image.open('/tmp/r.png').save('hero-[slug].webp','WEBP',quality=82,method=6)"
```
...
- Generated by: `site/tools/generate_og_images.py`
